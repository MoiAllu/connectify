...
(() => {
var exports = {};
exports.id = "pages/api/userposts";
exports.ids = ["pages/api/userposts"];
exports.modules = {
...
/***/ "(api)/./pages/api/userposts.ts":
/*!********************************!*\
  !*** ./pages/api/userposts.ts ***!
  \********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _lib_prisma__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../lib/prisma */ \"(api)/./lib/prisma.ts\");\n/* harmony import */ var _lib_Utilities_auth__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../lib/Utilities/auth */ \"(api)/./lib/Utilities/auth.ts\");\n\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_lib_Utilities_auth__WEBPACK_IMPORTED_MODULE_1__.validateRoute)(async (req, res, user)=>{\n    const post = await _lib_prisma__WEBPACK_IMPORTED_MODULE_0__[\"default\"].post.findMany({\n        where: {\n            userId: user.id\n        },\n        include: {\n            postlikes: true,\n            comments: {\n                orderBy: {\n                    createdAt: \"asc\"\n                },\n                select: {\n                    id: true,\n                    message: true,\n                    createdAt: true,\n                    updatedAt: true,\n                    postId: true,\n                    parentId: true,\n                    likes: true,\n                    user: {\n                        select: {\n                            id: true,\n                            name: true\n                        }\n                    },\n                    _count: {\n                        select: {\n                            likes: true\n                        }\n                    }\n                }\n            }\n        }\n    });\n    res.json(post);\n}));\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(api)/./pages/api/userposts.ts\n");
...
var __webpack_exports__ = (__webpack_exec__("(api)/./pages/api/userposts.ts"));
