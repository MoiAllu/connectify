    ...
    <div className="text-blue-grey flex flex-col items-center max-w-[700px] w-full text-[12px]">
      ...
      <div className="w-full max-w-[400px] bg-white p-6 flex flex-col gap-2 rounded-md">
        <div className="flex flex-col sm:flex-row gap-2 justify-between">
          <button className="bg-gray-200 rounded-md text-[10px] font-bold text-blue-grey flex justify-center items-center px-3 gap-3 py-2">
            <svg
        ...
        <form className="flex flex-col gap-2">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <div className="flex justify-center items-center gap-1 max-w-[350px] w-full border border-gray-300border-opacity-70 focus:border-opacity-100 rounded-md px-2 py-1">
              <input
                type="date"
                className="w-full bg-inherit focus-within:outline-none px-1"
              />
            </div>
            <div className="flex justify-between items-center gap-1 max-w-[350px] w-full border border-gray-300border-opacity-70 focus:border-opacity-100 rounded-md px-2 py-1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
          ...
          <button className="bg-blue text-white rounded-md py-1.5">
            Sign Up
          </button>
        </form>
